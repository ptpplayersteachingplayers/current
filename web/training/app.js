      ...
      el("div", { class: "wrap" }, [
        el("div", { class: "grid grid-2" }, [
          el("div", { class: "card" }, [
            ...
            el("p", { class: "figure mt-4", text: money(n("group_package_price_cents", 56000)) }),
            el("p", { class: "figure-label", text: "for the season" }),
            el("p", { class: "meta mt-4", text: `Groups are capped at ${n("group_max_players", 6)} and matched by age and level. A group runs once ${n("group_min_players", 4)} families are in — the page tells you how close it is rather than making you ask.` }),
          ...
          el("div", { class: "card" }, [
            ...
            el("p", { class: "figure mt-4", text: money(n("private_hourly_price_cents", 10000)) }),
            el("p", { class: "figure-label", text: "an hour" }),
            el("p", { class: "meta mt-4", text: "Sessions are offered where they join an existing block of work. It means fewer times on the board than a diary full of empty hours would show — and a coach who arrives fresh rather than after an hour in the car for a single hour of work." }),
